...
int main() {
    ...
    devices.push_back(new SmartLight("L101", "Living Room", "OFF", "08:00"));
    devices.push_back(new Thermostat("T102", "Bedroom", "ON", "08:15"));
    devices.push_back(new SecurityCamera("C103", "Main Gate", "ON", "08:30"));
    devices.push_back(new DoorLock("D104", "Main Door", "LOCKED", "08:45"));
