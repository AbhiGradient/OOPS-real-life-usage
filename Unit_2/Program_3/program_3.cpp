...
int main() {
    ...
    fleet.push_back(make_unique<Truck>("V001", "MH19-AB-0001", 10.5));
    fleet.push_back(make_unique<DeliveryVan>("V002", "MH19-CV-5196", 50));
    fleet.push_back(make_unique<Bike>("V003", "MH19-SS-5128", true));
